    ...
    static void hapusAnggota() {
        ...
        for (int i = 0; i < daftarAnggota.size(); i++) {
            ...
            System.out.printf("%-5d %-15s %-20s %-15s%n", 
                (i + 1), a.getId(), a.getNama(), a.getNoHp());
        }
        System.out.println("------------------------------------------------------------");
    ...
    static void lihatBarangVerifikasi() {
        ...
        if (pilihan == 0) {
            ...
            if (opsi == 1) {
                ...
                barangDipilih.setButuhVerifikasiPembayaran(false);
                barangDipilih.setPenawarTertinggi("Belum ada bid");
    ...
    static void ajukanLelang() {
        ...
        for (Barang b : daftarBarang) {
            if (b.getId().equals(idBarang) && b.getPemilik() != null && b.getPemilik().equals(currentUser) && !b.isSudahDilelang()) {
                b.setButuhPersetujuan(true);    // ✅ GANTI
                b.setSudahDilelang(true);       // ✅ GANTI
                System.out.println("\n====================================");
    ...
    public static void lihatRiwayatTransaksi() {
        ...
        for (int i = 0; i < riwayatTransaksiUser.size(); i++) {
            ...
            System.out.printf("%-5d %-20s %-15s Rp%,12d %-15s%n", 
                (i + 1), t.getBarang().getNama(),t.getBarang().getPemilik(),t.getHarga(),t.getTanggal());
        }
        System.out.println("------------------------------------------------------------");
    }
}
