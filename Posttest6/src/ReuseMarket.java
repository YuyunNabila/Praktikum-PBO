...
public class ReuseMarket {
    ...
    static void daftarAnggota() {
        ...
        System.out.print("Masukkan Username (minimal 5 karakter, huruf/angka): ");
        String username = scanner.nextLine().trim();
        if (!Anggota.isUsernameValid(username)) {
            System.out.println("\nError: Username harus minimal 5 karakter dan hanya huruf/angka.");
            return;
        }
        ...
        System.out.print("Masukkan Password (minimal 8 karakter, kombinasi huruf & angka): ");
        String password = scanner.nextLine().trim();
        if (!Anggota.isPasswordValid(password)) {
            System.out.println("\nError: Password harus minimal 8 karakter dan mengandung huruf & angka.");
            return;
        }

        System.out.print("Masukkan No HP (10–15 digit angka): ");
        String noHp = scanner.nextLine().trim();
        if (!Anggota.isNoHpValid(noHp)) {
            System.out.println("\nError: Nomor HP harus berupa 10–15 digit angka.");
            return;
        }

        daftarAnggota.add(new AnggotaBiasa(username, nama, password, noHp));
